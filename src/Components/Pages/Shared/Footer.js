...
const Footer = () => {
    return (
        <footer className="footer footer-center p-8 bg-black text-primary-content">
            <div>
                <img width="100" height="100" className="inline-block fill-current" src="https://www.freeiconspng.com/thumbs/camera-photo-png/photography-workshop-learn-how-to-set-up-and-take-photos-15.png" alt="" />

                <p className="font-bold text-xl">
                    Cute Photography <br />Providing reliable tech since 2015
                </p>
